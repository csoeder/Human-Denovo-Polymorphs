...
for rec in parser:						#	For each record in the FASTA...
	...
	call(['bsub', '-J', 'BLAT_%s_pan'%number, '-o', 'compprimBLATs/blat%s_pan.lsf.out'%number, 'blat', '/netscr/csoeder/1kGen/data/chimp/panTro4.fa','compprimBLATs/temp%s.fa'%number,  'compprimBLATs/pan_blat%s.psl'%number ])
	call(['bsub', '-J', 'BLAT_%s_gor'%number, '-o', 'compprimBLATs/blat%s_gor.lsf.out'%number, 'blat', '/netscr/csoeder/1kGen/data/gorilla/gorGor3.fa','compprimBLATs/temps%s.fa'%number,  'compprimBLATs/gor_blat%s.psl'%number ])
