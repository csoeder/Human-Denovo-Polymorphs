...
for rec in parser:						#	For each record in the FASTA...
	...
	call(['bsub', '-J', 'BLAT_%s_gor'%number, '-o', 'compprimBLATs/blat%s_gor.lsf.out'%number, 'blat', '%s/gorilla/gorGor3.fa'%DATA_DIR, 'compprimBLATs/temps%s.fa'%number,  'compprimBLATs/gor_blat%s.psl'%number ])
