...
#############################################################################
### Align the Trinity #######################################
bsub -J TrinAlign_$FOLDER -w "done(faidx_$FOLDER)" -o TrinAlign.lsf.out bowtie2 -f -x $DATA_DIR/hg19_bowtie2index/hg19 -U Trinity_files.Trinity.fasta -S "$FOLDER"_aligned.sam
