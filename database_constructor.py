...
curr.execute("CREATE TABLE location ( location_pk serial PRIMARY KEY, chrom varchar(20), start bigint, stop bigint, strand varchar(2), ref varchar(20), var text, poly boolean, canon_seq serial references sequence(sequence_pk), lookback_clean boolean, pan_noncoding boolean, gor_noncoding boolean, handchecked boolean, meta text ) ;")
