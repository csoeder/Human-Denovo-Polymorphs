...
bsub -J $1_aligned_fork -q week -w "done(faidx_$1) && done(bamsort_$1) && done(gather_maps_$1)" -o aligned_fork.lsf.out -q week "sh $SCRIPT_DIR/aligned_fork_v3.5_parallel.sh $1_Assemblies_mapped.sam $1_mapsplice_alignment.sort.bam Trinity_files.Trinity.fasta $1"
